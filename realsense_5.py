...
while True:
    ...
    if ball_detected:
        ...
        cv2.putText(result, f"Distance: {distance / 1000:.2f} m", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
        
        # Print untuk debugging
        print(f"Center: {center}, Distance: {distance / 1000:.2f} m, 3D Position: {ball_3d}")
